...
class Document(BaseDocument):
    ...
    def from_file(cls, f, fname=None, readers=None):
        ...
        """
        # print(cls)
        # print(isinstance(f,six.string_types))
    ...
    def from_string(cls, fstring, fname=None, readers=None):
        ...
        # print(isinstance(fstring, six.text_type))
    ...
    def records(self):
        ...
        for i, el in enumerate(self.elements):
            # print(isinstance(el, Title))
            # print(i,el)
            # print(type(el))
            last_id_record = None

            # Save title compound
            if isinstance(el, Title):  # sinstance() 函数来判断一个对象是否是一个已知的类型，类似 type()。 如果是，则输出true
                # print(el)
            ...
            # print(len(el.sentences),el.sentences)
    ...
    def cems(self):
        ...
        return list(set([n for el in self.elements for n in el.cems]))  # set() 函数创建一个无序不重复元素集
