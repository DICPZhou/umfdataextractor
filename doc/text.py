...
from ..parse.cem import  CompoundHeadingParser, CompoundParser, chemical_name
from ..parse.table import CaptionContextParser
from ..parse.diameter import TextDiameterParser
from ..parse.pressure import TextPressParser
from ..parse.particle_density import TextParticledensityParser
from ..parse.temperature import TextTempParser
from ..parse.velocity import TextUmfParser
...
class Paragraph(Text):
    ...
    parsers = [TextDiameterParser(), TextParticledensityParser(), TextUmfParser(), TextTempParser(), TextPressParser()]  #  ApparatusParser(),
...
class Footnote(Text):
    # print(Text)
    parsers = [CaptionContextParser(),  TextDiameterParser(),
               TextUmfParser(), TextParticledensityParser(), TextTempParser(), TextPressParser()]  #  ApparatusParser()
...
class Caption(Text):
    parsers = [CompoundParser(),  CaptionContextParser(),  TextDiameterParser(), TextParticledensityParser(), TextUmfParser(), TextTempParser(), TextPressParser()]  # ApparatusParser(),
